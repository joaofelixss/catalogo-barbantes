...
const CategoryHighlightSection: React.FC<CategoryHighlightSectionProps> = React.memo(
  ({ title, products, onAddToCart, viewMoreLink }) => {
...
CategoryHighlightSection.displayName = 'CategoryHighlightSection'
