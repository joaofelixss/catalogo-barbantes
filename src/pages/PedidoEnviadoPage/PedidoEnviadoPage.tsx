// src/pages/PedidoEnviadoPage.tsx
...
const PedidoEnviadoPage: React.FC = () => {
  return (
    <div className={styles.pedidoEnviadoContainer}>
      ...
      <p>
        Seu pedido foi enviado para o nosso WhatsApp e entraremos em contato em
        breve para confirmar os detalhes de pagamento e entrega.
      </p>
      <p>
