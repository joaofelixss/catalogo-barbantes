// src/components/CartItem/__tests__/CartItem.test.tsx
import React from "react";
import { render, screen, fireEvent } from "@testing-library/react";
import userEvent from "@testing-library/user-event";
import CartItem from "../CartItem";
import { CartItem as CartItemType, Product } from "../../../types/product";
import formatPrice from "../../../utils/formatPrice"; // Importe a função se necessário

jest.mock("../../../utils/formatPrice"); // Mock da função formatPrice para não afetar o teste
